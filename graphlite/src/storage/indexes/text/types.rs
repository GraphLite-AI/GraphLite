...
pub fn english_stopwords() -> Vec<&'static str> {
    vec![
        ...
        "into", "is", "isn't", "it", "it's", "its", "itself", "just", "k", "let's", "m",
...
impl AnalysisResult {
    ...
    pub fn new(tokens: Vec<Token>) -> Self {
        let unique_count = tokens.iter().map(|t| &t.text).collect::<std::collections::HashSet<_>>().len();
        Self { tokens, unique_count }
    }
