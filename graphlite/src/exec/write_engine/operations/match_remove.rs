...
mod tests {
    ...
    fn test_literal_to_value_string() {
        ...
        let value = MatchRemoveExecutor::literal_to_value(&literal);
    ...
    fn test_node_matches_pattern_empty_pattern() {
        ...
        assert!(MatchRemoveExecutor::node_matches_pattern(&node, &pattern));
    }
    ...
    #[test]
    fn test_node_matches_pattern_property_match() {
        // Node with matching property
