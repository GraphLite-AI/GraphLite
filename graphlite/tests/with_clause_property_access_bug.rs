...
fn test_with_clause_property_access_bug() {
    ...
    fixture.assert_query_succeeds(&format!("SESSION SET GRAPH /{}/bug_test", fixture.schema_name()));
    ...
    let result1 = fixture.assert_query_succeeds(r#"
    ...
    let result2 = fixture.assert_query_succeeds(r#"
        MATCH (n:Node {id: 'test123'})
    ...
    let result3 = fixture.assert_query_succeeds(r#"
        MATCH (n:Node {id: 'test123'})
    ...
    let result4 = fixture.assert_query_succeeds(r#"
        MATCH (n:Node {id: 'test123'})
        WITH n as node
...
fn test_with_clause_multiple_nodes_workaround() {
    ...
    // Setup
    fixture.assert_query_succeeds(&format!("CREATE GRAPH /{}/workaround", fixture.schema_name()));
    fixture.assert_query_succeeds(&format!("SESSION SET GRAPH /{}/workaround", fixture.schema_name()));
    ...
    let result = fixture.assert_query_succeeds(r#"
